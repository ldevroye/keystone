...
A further step would be to study how the complexity of the backup enclave affects both security and performance, especially when the recovery logic itself becomes more stateful.
