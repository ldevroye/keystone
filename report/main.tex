...
One could launch a full set of host testing with \verb|HOST_TESTING| (to analyze the runtimes for example) while enableing the \verb|EAPP_TESTING| making the enclave only executing tests (and even more, returning failed tests that the host will try to accomplish).
