...
\subsection*{\texttt{eapp/eapp_test}}
\label{file:eapp_test}
\srcattach{src/rewind/eapp/eapp_test.c}{examples/rewind/eapp/eapp_test.c}
\srcattach{src/rewind/eapp/eapp_test.h}{examples/rewind/eapp/eapp_test.h}
...
\subsection*{\texttt{host/host_test}}
\label{file:host}
\srcattach{src/rewind/host/host_test.cpp}{examples/rewind/host/host_test.cpp}
\srcattach{src/rewind/host/host_test.hpp}{examples/rewind/host/host_test.hpp}
