...
\newcommand{\keystonegithub}{%
    \href{https://github.com/keystone-enclave/keystone}{https://github.com/keystone-enclave/keystone} (\cite{keystone-repo})
}
...
The chosen platform to implement it is Keystone(\cite{keystone-web}, \cite{keystone-repo}), it is an open framework used for architecturing TEEs on a RISC-V architecture.
\\
...
- \href{https://docs.keystone-enclave.org/en/latest/Getting-Started/How-Keystone-Works/Keystone-Basics.html#keystone-basics}{Keystone Website : 2.2. Keystone Basics} (\cite{keystone-web})
\\

Its implementation can be found on the corresponding github reposity: \keystonegithub.\\
The documentation can be found at : \href{https://docs.keystone-enclave.org/en/latest/index.html}{https://docs.keystone-enclave.org/en/latest/index.html} (\cite{keystone-web})
...
RISC-V has three (3) priviliege levels (\href{https://docs.keystone-enclave.org/en/latest/Getting-Started/How-Keystone-Works/RISC-V-Background.html#risc-v-privilieged-isa}
                                            {2.1.2 RISC-V Backgrond} \{\cite{keystone-web}\}):
\begin{itemize}
...
\begin{figure}[H]
    ...
    \caption{Enclave overall life cycle (2.2.3 \cite{keystone-web})}
