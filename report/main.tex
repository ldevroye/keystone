...
Furthermore, the host keeps the last saved checkpoint blob in a variable: \verb|inline vector<uint8_t> saved_blob;|.
This variable will be used for both loading and saving.

\begin{verbatim}
/* WRAPPER EDGE CALL LOAD */
void load_checkpoint_blob_dispatch(void* buffer)
{
    // checks if there is a saved checkpoint
    if (saved_blob.empty()) 
    {
        edge_call->return_data.call_status = CALL_STATUS_ERROR;
        return;
