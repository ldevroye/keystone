...
\begin{itemize}
    ...
    \item \verb|FAULT_SEED|: sets the seed to start from for the fault model (if the seed is not set to random)
    \item \verb|ENABLE_TESTING|: launches the execution in testing mode, reduce outputs and run several itaration to give data to analyze
    \item \verb|ANALYSIS_RUNS|: sets the number of runs for the analysis
