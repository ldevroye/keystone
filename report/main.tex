...
There are two parts: the \textit{analysis}, where we quantify execution costs and overhead, and the \textit{cyber security}, where we validate the threat model assumptions and security objectives from \ref{sec:threat-model}.
\\
...
Now, for the \textit{cyber security}, we will assess that the security objects are, along with the requirements, respected and fulfilled.
