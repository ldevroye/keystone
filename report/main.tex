...
\hypersetup{
    ...
    pdfsubject={Fault-Tolerant Microarchitectures: Fault recovery by rewinding enclaves in a TEE on a RISC-V architecture (Keystone)},
...
- \href{https://docs.keystone-enclave.org/en/latest/Getting-Started/How-Keystone-Works/Keystone-Basics.html#keystone-basics}{Keystone Website : 2.2. Keystone Basics}
\\
Its implementation can be found on the corresponding github reposity: \keystonegithub.\\
The documentation can be found at : \href{https://docs.keystone-enclave.org/en/latest/index.html}{https://docs.keystone-enclave.org/en/latest/index.html}
...
\\
RISC-V has three (3) priviliege levels (\href{https://docs.keystone-enclave.org/en/latest/Getting-Started/How-Keystone-Works/RISC-V-Background.html#risc-v-privilieged-isa}{2.1.2 RISC-V Backgrond}):
\begin{itemize}
...
"Physical Memory Protection (PMP) is a part of the RISC-V Privileged Architecture Specification which discribes the interface for a standard RISC-V memory protection unit." - \href{https://sifive.github.io/freedom-metal-docs/devguide/pmps.html}{Physical Memory Protection - SiFive}
...
\\
More importantly, PMP is used by the SM to create memory isolation.
...
\\
The Operating System (OS) and the enclaves can call SM functions using the Supervisor Binary Interface (SBI).
...
Moreover, the OS cannot tamper with the page table of the enclaves, this is because of PMP restrictions on the OS.  
...
These files can be found in the \texttt{examples/rewind/} subfolder of the repository :\github and they are compiled in this pdf.
...
These files can be found at the root of the repository :\github and they are compiled in this pdf.
