...
The chosen platform to implement it is Keystone (\cite{keystone-web, keystone-docs keystone-repo}), it is an open framework used for architecturing TEEs on a RISC-V architecture.
\\
