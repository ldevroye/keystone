...
and security objectives from \ref{sec:threat-model}.
...
We will discuss the relevance of these posssible values of the three different costs in the Section \ref{sec:Discussion}.
...
Nevertheless, as $K$ grows, the first slope gets steeper. 
...
Now that the computation and data analysis is done, we will address the cyber security assumptions and requirements.

\subsection{Security objectives}
There are four different security objectives, stated in \ref{sec:threat-model}:
